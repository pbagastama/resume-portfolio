  ...
  return (
    <section className='min-h-screen flex items-center justify-center relative overflow-hidden'>
      ...
      <div className='absolute inset-0 overflow-hidden'>
        ...
        <div
          className='absolute bottom-1/4 -right-20 w-96 h-96 bg-accent/20 rounded-full blur-3xl animate-glow-pulse'
      ...
      <div className='container relative z-10 px-4'>
        <div className='max-w-4xl mx-auto text-center space-y-8'>
          ...
          <p className='text-xl text-muted-foreground max-w-2xl mx-auto animate-fade-in-delay'>
            Building fast, scalable, and beautiful web experiences with React &
            Next.js. Turning ideas into seamless, high-impact digital products.
          </p>
